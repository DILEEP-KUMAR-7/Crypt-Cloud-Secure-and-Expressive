                ...
                <div class="header-content clearfix"> <a class="logo" href="#">User Home</a>
                    <nav class="navigation" role="navigation">
                        <ul class="primary-nav">
                            ...
                            <li><a href="verified.jsp">Back</a></li>
                        </ul>
                    </nav>
            ...
            <div class="row">
                <div>
                    ...
                    <div style="width: 50%; float:right">
                        ...
                        <hr>
                        <form action="up_code.jsp" method="post">
                            <table style="width:100%">
                                <tr>
                                    <!--<td><label for="Verify"><b>Secret Key</b></label></td>-->
                                    <td><textarea style="width:400px; height:150px" name="str"><%=str%></textarea><br></td> 
                                </tr>
                                <tr>
                                    <!--<td></td>-->
                                    <td><button style="width:100px; height:45px" type="submit" class="registerbtn">UPDATE</button></td> 
                                </tr>
