...
<!--            <div id="myCarousel" class="carousel slide" data-ride="carousel"> 
        ...
        <section id="services" class="section services">
            ...
            <div><table id="customers">
                    ...
                    <tr>
                        <%
                            String acces = (String) session.getAttribute("ssacces");
                            System.out.println("------------ " + acces);
                            Connection con = Dbconn1.getConnection();
                            Statement st = con.createStatement();
                            try {
                                ResultSet rs = st.executeQuery("select * from upload where attri='" + acces + "' ");
                                while (rs.next()) {
                        ...
                        <td style="color: #080808"><a style="color: #db3615" href="request.jsp?id=<%=rs.getString("id") %>">Send</a></td>
 </tr>
                        <%                                }
                            } catch (Exception ex) {
                                ex.printStackTrace();
