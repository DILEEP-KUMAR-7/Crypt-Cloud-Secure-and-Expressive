...
Access Control for Cloud Storage</title>
    ...
    <body>
        ...
        <section class="tophead" role="tophead"> 
            <!-- Navigation Section -->
            <header id="header">
                <div class="header-content clearfix"> <a class="logo" href="#">Data User</a>
                ...
                <div class="row">
                    <div>
                        ...
                        <div style="width: 50%; float:right">
                            <left><h3 style="font-family: fantasy"> DATA USER lOGIN PAGE</h3></left>
                            ...
                            <table style="width:100%">
                                ...
                                <tr>
                                    <td><a href="ureg.jsp">Create Account!!</a></td>
