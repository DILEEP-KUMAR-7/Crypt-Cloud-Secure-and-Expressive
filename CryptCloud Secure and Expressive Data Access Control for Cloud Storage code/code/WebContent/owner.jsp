...
<html class="no-js" lang=""> <!--<![endif]-->
    ...
    <head>
        ...
        <title>CryptCloud+: Secure and Expressive Data Access Control for Cloud Storage</title>
    ...
    <body>
        ...
        <section class="tophead" role="tophead"> 
            <!-- Navigation Section -->
            <header id="header">
                <div class="header-content clearfix"> <a class="logo" href="#">Data Owner</a>
                ...
                <div class="row">
                    <div>
                        <div style="width: 50%; float:left">
                            <center><br><img style="width: 400px; height: 300px" src="images/lap.jpg"> </center>
                        </div>

                        <div style="width: 50%; float:right">
                            <left><h3 style="font-family: fantasy"> DATA OWNER lOGIN PAGE</h3></left>
                            <!--<p>Please fill in this form to create an account.</p>-->
                            <hr>
                            <form action="owner_login.jsp" method="get">
