...
Access Control for Cloud Storage</title>
    ...
    <body>
        ...
        <section class="tophead" role="tophead"> 
            <!-- Navigation Section -->
            <header id="header">
                <div class="header-content clearfix"> <a class="logo" href="#">Semi-trusted authority </a>
                ...
                <div class="row">
                    <div>
                        ...
                        <div style="width: 50%; float:right">
                            <left><h3 style="font-family: fantasy">Semi-Trusted Authority login </h3></left>
                            <!--<p>Please fill in this form to create an account.</p>-->
                            <hr>
                            <form action="sta_code.jsp" method="get">
