...
<html class="no-js" lang=""> <!--<![endif]-->
    ...
    <body>
        ...
        <section class="tophead" role="tophead"> 
            <!-- Navigation Section -->
            <header id="header">
                <div class="header-content clearfix"> <a class="logo" href="#">STA Home</a>
                    <nav class="navigation" role="navigation">
                        <ul class="primary-nav">
                            <li><a htef=""></a></li>
                            <li><a href="sta_home.jsp">STA Home</a></li>
                            <li><a href="file_view3.jsp">File View</a></li>
        ...
        <section id="services" class="section services">
            <h3 style="font-family: fantasy"><center>User Request Details</center></h3>
            <center>
                <div><table id="customers">
                        <tr>
                            <th style="color: #080808">Req Id</th>
                            <th style="color: #080808">UId</th>
                            ...
                            <th style="color: #080808">Response</th>
                        </tr>
                        <tr>
                            <%
                                try {
                            ...
                            <td style="color: #080808"><a href="response.jsp?id=<%=rs.getString("id")%>">send</a></td>
                        </tr>
                        <%                                }
                            } catch (Exception ex) {
                                ex.printStackTrace();
