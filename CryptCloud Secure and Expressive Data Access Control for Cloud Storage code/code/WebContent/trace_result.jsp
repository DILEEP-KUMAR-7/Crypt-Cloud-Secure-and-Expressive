...
<html class="no-js" lang=""> <!--<![endif]-->
    ...
    <body>
        ...
        <section id="services" class="section services">
            <h3 style="font-family: fantasy"><center>File Trace Result</center></h3>
                        ...
                        <tr>
                            <%
                                ...
                                try {
                                    ...
                                    ResultSet rs = st.executeQuery("select * from t_request where oid='" + oid + "'");
                                    while (rs.next()) {
                            %>                  
                            ...
                            <td><a href="view.jsp?id=<%=rs.getString("skey")%>">check</a></td>
                        </tr>
                        <%                                }
                            } catch (Exception ex) {
                                ex.printStackTrace();
