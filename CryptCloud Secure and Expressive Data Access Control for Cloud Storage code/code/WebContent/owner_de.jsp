...
<html class="no-js" lang=""> <!--<![endif]-->
    ...
    <body>
        ...
        <section class="tophead" role="tophead"> 
            <!-- Navigation Section -->
            <header id="header">
                <div class="header-content clearfix"> <a class="logo" href="#">Cloud Server Home</a>
                    <nav class="navigation" role="navigation">
                        <ul class="primary-nav">
                            <li><a href="cloud_home.jsp">Home</a></li>
                            <li><a href="file_view4.jsp">File Details</a></li>
                            <li><a href="user_de1.jsp">User Details</a></li>
        ...
        <section id="services" class="section services">
            <h3 style="font-family: fantasy"><center>Owner Details</center></h3>
            <center>
                <div><table id="customers">
                        <tr>
                            <th style="color: #080808">Id</th>
                            <th style="color: #080808">Name</th>
                            <th style="color: #080808">Email</th>
                            <th style="color: #080808">Gender</th>
                            <th style="color: #080808">State</th>
                            <th style="color: #080808">Country</th>
                            <th style="color: #080808">Status</th>
                        </tr>
                        <tr>
                            <%
                                try {
                            ...
                            <td style="color: #080808"><%=rs.getString("gender")%></td>
