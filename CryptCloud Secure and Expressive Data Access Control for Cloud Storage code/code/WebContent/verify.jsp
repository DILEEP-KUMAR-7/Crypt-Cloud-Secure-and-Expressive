                ...
                <div class="row">
                    <div>
                        <div style="width: 50%; float:left">
                            <center><br><img style="width: 400px; height: 300px" src="images/verify.png"> </center>
                        </div>

                        <div style="width: 50%; float:right">
                            <left><h3 style="font-family: fantasy"> Verify Secret Key</h3></left>
                            <!--<p>Please fill in this form to create an account.</p>-->
                            <hr>
                            <form action="veri.jsp" method="get">
...
<!--                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><input style="width:250px; height:50px" type="password" placeholder="Secret Keys" name="secretkey" required><br></td> 
                                    </tr>
                                    <tr>
                                        <td></td>
                                        <td><button style="width:150px; height:50px" type="submit" class="registerbtn">Verify</button></td> 
                                    </tr>
