...
<html class="no-js" lang=""> <!--<![endif]-->
    ...
    <body>
        ...
        <section id="services" class="section services">
            <h3 style="font-family: fantasy"><center>Trace Request</center></h3>
            <center>
                <div><table id="customers">
                        ...
                        <tr>
                            <%
                                String oid = (String) session.getAttribute("sid");
                                System.out.println("------------ " + oid);
                                Connection con = Dbconn1.getConnection();
                                Statement st = con.createStatement();
                                try {
                                    ResultSet rs = st.executeQuery("select * from upload where oid='" + oid + "' ");
                                    while (rs.next()) {
                            ...
                            <td><a href="t_req.jsp?id=<%=rs.getString("id")%>">Click</a></td>
 </tr>
                            <%                                }
                                } catch (Exception ex) {
                                    ex.printStackTrace();
